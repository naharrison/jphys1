...
public class PidAnalysis1 {
	...
	public static void main(String[] args) throws IOException {
		...
		Axis v1Axis = new Axis(20, 0, 1); // 20 bins from 0 to 1 (width = 0.1)
		Axis v2Axis = new Axis(20, 0, 1); // 20 bins from 0 to 1 (width = 0.1)
		Axis v3Axis = new Axis(20, 0, 1); // 20 bins from 0 to 1 (width = 0.1)
		Axis v4Axis = new Axis(20, 0, 1); // 20 bins from 0 to 1 (width = 0.1)
		Axis v5Axis = new Axis(20, 0, 1); // 20 bins from 0 to 1 (width = 0.1)
